...
forms = {0: ["Python test to Clint"],
         1: [fill(12), fill(8), fill(24), fill(22), fill(30), fill(29), fill(38), fill(12), fill(5), fill(5), fill(5), fill(5),
             fill(29), "Y", fill(4), fill(5), fill(2), fill(3), fill(4), fill(22), fill(29), fill(38), fill(12),
             fill(5), fill(5), fill(5), fill(5), "Y", fill(4), fill(38), fill(38), fill(38), fill(38)],
