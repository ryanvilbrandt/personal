...
version = "1.0.0.2"
distribution = "Point_Buy_Calc_v" + "_".join(version.split(".")[:-1])
...
class Target:
    def __init__(self, **kw):
        ...
        self.company_name = ""
        self.copyright = "(c) 2012, Ryan Vilbrandt"
        self.name = "Point Buy Calculator"
...
test_wx = Target(
    description = "Calculates point buy totals",
    script = filename,
