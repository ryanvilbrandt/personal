...
class Item:
    round_factories = False
    default_factory_speed = S_ASSEMBLER

    def __init__(self, name, crafting_time=1.0, num_created=1, recipe=None, factory_speed=None):
        self.name = name
        self.crafting_time = crafting_time
        self.num_created = num_created
        self.recipe = recipe
        self.is_raw_material = recipe is None
        if factory_speed is None:
            factory_speed = self.default_factory_speed
...
if __name__ == "__main__":
    ...
    SINGLE_CYLINDER_ENGINE = Item("Single-cylinder engine", 0.6, 1, {IRON_GEAR: 1, IRON_PLATE: 1})
    SMALL_ELECTRIC_MOTOR = Item("Small electric motor", 0.8, 1, {COPPER_CABLE: 6, IRON_GEAR: 1, IRON_PLATE: 1})
    ADVANCED_CIRCUIT = Item("Advanced circuit", 6, 1, {COPPER_CABLE: 4, ELECTRONIC_CIRCUIT: 2, PLASTIC_BAR: 2})
    MULTI_CYLINDER_ENGINE = Item("Multi-cylinder engine", 10, 1, {IRON_GEAR: 2, SINGLE_CYLINDER_ENGINE: 2, STEEL_PLATE: 2})
    BIG_ELECTRIC_MOTOR = Item("Big electric motor", 10, 1, {ELECTRONIC_CIRCUIT: 4, SMALL_ELECTRIC_MOTOR: 2, STEEL_PLATE: 2, LUBRICANT: 40})
    ...
    TRANSPORT_BELT = Item("Transport belt", 0.5, 2, {SINGLE_CYLINDER_ENGINE: 1, IRON_PLATE: 1})
    BURNER_INSERTER = Item("Burner inserter", 0.5, 1, {IRON_STICK: 2, SINGLE_CYLINDER_ENGINE: 1})
    ELECTRIC_INSERTER = Item("Inserter", 0.5, 1, {SMALL_ELECTRIC_MOTOR: 1, BURNER_INSERTER: 1})
    ...
    RADAR = Item("Radar", 0.5, 1, {ELECTRONIC_CIRCUIT: 8, SMALL_ELECTRIC_MOTOR: 4, STONE_BRICK: 4, IRON_PLATE: 20})

    # Machines


    # Robots
    FLYING_ROBOT_FRAME = Item("Flying robot frame", 20, 1, {ELECTRONIC_CIRCUIT: 4, BIG_ELECTRIC_MOTOR: 4, BATTERY: 4, STEEL_PLATE: 4})
    ...
    LASER_TURRET = Item("Laser turret", 20, 1, {ELECTRONIC_CIRCUIT: 20, SMALL_ELECTRIC_MOTOR: 5, BATTERY: 12, GLASS: 20, STEEL_PLATE: 20})
    ...
    CHEMICAL_SCIENCE = Item("Chemical science pack", 24, 2, {ADVANCED_CIRCUIT: 3, MULTI_CYLINDER_ENGINE: 2, SULFUR: 1})
    ...
    UTILITY_SCIENCE.analyze(num_per_second_needed=1.25, ignore=[PROCESSING_UNIT, PLASTIC_BAR, BATTERY, ELECTRONIC_CIRCUIT, GLASS])
