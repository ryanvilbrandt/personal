...
class Target:
    def __init__(self, **kw):
        ...
        self.company_name = "Zonar Systems"
        self.copyright = "(c) 2011, Zonar Systems"
        self.name = "Truck Board Device ID Generator"
...
test_wx = Target(
    description = "Creates list of truck board device IDs",
    script = filename,
##    other_resources = [(RT_MANIFEST, 1, manifest_template % dict(prog=distribution))],
    icon_resources = [(1, "zonar_full.ico")],
