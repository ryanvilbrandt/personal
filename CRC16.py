...
s = "\x02\x03\x1a\x00\xb2\x0c\t\x00\x00\x00\x00\x01\x08\x01\x02d\xfc\x8c#\x84\x91\x9a\xff"
...
def MyCRC16(data):
        crc = 0xFFFF
        for c in data:
                crc = AddByteToCRC(ord(c), crc)

        return (crc)

def AddByteToCRC(wData, m_wCRC):
...
print time.clock()-t
print crc
print "{0:04x}".format(crc)
print "{0:016b}".format(crc)
print "{0:016b}".format(crc ^ 0xFFFF)
print ""
...
print "This is wrong: {0:04x}".format(crcval)
